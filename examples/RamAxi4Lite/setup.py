...
static_setup_data = {
    ...
    "url": "https://github.com/eccelerators//simstm/examples/RamAxi4Lite/",
    "description": "RamAxi4Lite",
    ...
    "dependency_links": [],
    "package_data": {},
    "project_name": "RamAxi4Lite",
    "top_entity": "Dut",
    "top_entity_file": "src/vhdl/Dut.vhd",
    "tb_top_entity": "tbTop",
    "tb_top_entity_file": "/tb/hdl/tbTop.vhd",
    "tb_simstm_entry_namespace": "RamAxi4LiteBusExample",
    ...
    "src_data_files" : [(
        "RamAxi4Lite/src/vhdl", [
            {"file":"src/vhdl/Dut.vhd", "file_type":"VHDL 2008", "hdl_order":"00090"},
            {"file":"src/vhdl/RamAxi4Lite.vhd", "file_type":"VHDL 2008", "hdl_order":"00080"}
        ])
    ],
    "tb_data_files" : [(
        "RamAxi4Lite/tb/hdl/src_to_customize", [
    ...
    "src_tb_simstm_data_files" : [(
        "RamAxi4Lite/tb/simstm/ram", [
            {"file":"tb/simstm/ram/ram.stm"}
        ]),(
        "RamAxi4Lite/tb/simstm", [
