...
architecture behavioural of tbTop is
    ...
    signal LoadStepValue : std_logic_vector(7 downto 0) := (others => '0');
...
begin
    ...
    signals_in.in_signal_2001 <= Count;
    signals_in.in_signal_2002 <= '0';
    signals_in.in_signal_2003 <= '0';
    
    LoadStepValue <= signals_out.out_signal_3001;
