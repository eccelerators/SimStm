...
static_setup_data = {
    ...
    "url": "https://github.com/eccelerators//simstm/examples/CounterSuiteCaseIndexed/",
    "description": "CounterSuiteCaseIndexed",
    ...
    "dependency_links": [],
    "package_data": {},
    "project_name": "CounterSuiteCaseIndexed",
    "top_entity": "Dut",
    "top_entity_file": "src/vhdl/Dut.vhd",
    "tb_top_entity": "tbTop",
    "tb_top_entity_file": "/tb/hdl/tbTop.vhd",
    "tb_simstm_entry_namespace": "CounterSuiteCaseIndexed",
    "tb_simstm_entry_file": "testMain.stm",
    "test_suites" : [
        {"testsuite-name":"testSuiteIndexedCount", "file":"TestSuites/TestSuiteIndexedCount.stm", "testsuite-indexes":"4", "entry-file":"testMainSuiteIndexedCount.stm", "entry-label":"CounterSuiteCaseIndexed.testMainSuiteIndexedCount"}
    ],
    "test_labs" : [
    ],
    "other_data_files" : [(
    ...
    "src_data_files" : [(
        "CounterSuiteCaseIndexed/src/vhdl", [
    ...
    "tb_data_files" : [(
        "CounterSuiteCaseIndexed/tb/hdl/src_to_customize", [
    ...
    "src_tb_simstm_data_files" : [(
        "CounterSuiteCaseIndexed/tb/simstm/count", [
            {"file":"tb/simstm/count/count.stm"}
        ]),(
        "CounterSuiteCaseIndexed/tb/simstm/common", [
            {"file":"tb/simstm/common/common.stm"}
        ]),(
        "CounterSuiteCaseIndexed/tb/simstm/TestSuites", [
            {"file":"tb/simstm/TestSuites/TestSuiteIndexedCount.stm"}
        ]),(
        "CounterSuiteCaseIndexed/tb/simstm", [
            {"file":"tb/simstm/testMainSuiteIndexedCount.stm"},
            {"file":"tb/simstm/testMain.stm"}
        ]),(
        "CounterSuiteCaseIndexed/../../lib", [
            {"file":"../../lib/util.stm"},
