...
static_setup_data = {
    ...
    "url": "https://github.com/eccelerators/CounterSuiteCaseIndexed/",
    ...
    "tb_top_entity_file": "/tb/hdl/tbTop.vhd",
        "test_suites" : [
            {"testsuite-name":"testSuiteIndexedCount", "file":"TestSuites/TestSuiteIndexedCount.stm", "testsuite-indexes":"3", "entry-file":"testMainSuiteIndexedCount.stm", "entry-label":"CounterSuiteCaseIndexed.testMainSuiteIndexedCount"}
    ],
    "test_labs" : [
    ],
    "other_data_files" : [(
