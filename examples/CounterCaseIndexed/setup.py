...
static_setup_data = {
    ...
    "url": "https://github.com/eccelerators//simstm/examples/CounterCaseIndexed/",
    "description": "CounterCaseIndexed",
    ...
    "dependency_links": [],
    "package_data": {},
    "project_name": "CounterCaseIndexed",
    "top_entity": "Dut",
    "top_entity_file": "src/vhdl/Dut.vhd",
    "tb_top_entity": "tbTop",
    "tb_top_entity_file": "/tb/hdl/tbTop.vhd",
    "tb_simstm_entry_namespace": "CounterCaseIndexed",
    "tb_simstm_entry_file": "testMain.stm",
    "test_suites" : [
        {"testsuite-name":"testSuiteCount", "file":"TestSuites/TestSuiteCount.stm", "entry-file":"testMainSuiteCount.stm", "entry-label":"CounterCaseIndexed.testMainSuiteCount"}
    ],
    "test_labs" : [
    ],
    "other_data_files" : [(
