...
static_setup_data = {
    ...
    "url": "https://github.com/eccelerators//simstm/examples/CounterPlain/",
    ...
    "tb_simstm_entry_namespace": "CounterPlain",
    "tb_simstm_entry_file": "testMain.stm",
    "test_suites" : [
        {"testsuite-name":"testSuiteCount", "file":"TestSuites/TestSuiteCount.stm", "entry-file":"testMainSuiteCount.stm", "entry-label":"CounterPlain.testMainSuiteCount"}
    ],
    "test_labs" : [
    ],
    "other_data_files" : [(
