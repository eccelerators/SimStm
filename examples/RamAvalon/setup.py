...
static_setup_data = {
    ...
    "url": "https://github.com/eccelerators//simstm/examples/RamAvalon/",
    "description": "RamAvalon",
    ...
    "dependency_links": [],
    "package_data": {},
    "project_name": "RamAvalon",
    "top_entity": "Dut",
    "top_entity_file": "src/vhdl/Dut.vhd",
    "tb_top_entity": "tbTop",
    "tb_top_entity_file": "/tb/hdl/tbTop.vhd",
    "tb_simstm_entry_namespace": "RamAvalonBusExample",
    ...
    "src_data_files" : [(
        "RamAvalon/src/vhdl", [
            ...
            {"file":"src/vhdl/RamAvalon.vhd", "file_type":"VHDL 2008", "hdl_order":"00090"}
        ])
    ],
    "tb_data_files" : [(
        "RamAvalon/tb/hdl/src_to_customize", [
