...
static_setup_data = {
    ...
    "url": "https://github.com/eccelerators//simstm/examples/CounterLab/",
    "description": "CounterLab",
    ...
    "dependency_links": [],
    "package_data": {},
    "project_name": "CounterLab",
    "top_entity": "Dut",
    "top_entity_file": "src/vhdl/Dut.vhd",
    "tb_top_entity": "tbTop",
    "tb_top_entity_file": "/tb/hdl/tbTop.vhd",
    "tb_simstm_entry_namespace": "CounterLab",
    "tb_simstm_entry_file": "testMain.stm",
    "test_suites" : [
    ],
    "test_labs" : [
            {"testlab-name":"testLabCount", "file":"TestLabs/TestLabCount.stm", "entry-file":"testMainLabCount.stm", "entry-label":"CounterLab.testMainLabCount"}
    ],
    "other_data_files" : [(
        "CounterLab", [
        ])
    ...
    "tb_data_files" : [(
        "CounterLab/tb/hdl/src_to_customize", [
    ...
    "src_tb_simstm_data_files" : [(
        "CounterLab/tb/simstm/count", [
            {"file":"tb/simstm/count/count.stm"}
        ]),(
        "CounterLab/tb/simstm/common", [
            {"file":"tb/simstm/common/common.stm"}
        ]),(
        "CounterLab/tb/simstm/TestLabs", [
            {"file":"tb/simstm/TestLabs/TestLabCount.stm"}
        ]),(
        "CounterLab/tb/simstm", [
            {"file":"tb/simstm/testMain.stm"},
            {"file":"tb/simstm/testMainLabCount.stm"}
        ]),(
        "CounterLab/../../lib", [
            {"file":"../../lib/util.stm"},
