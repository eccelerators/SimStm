...
message. 
The message string can contain {} placeholders, refer to the `log message`_ instruction, 
...
The line can be derived from an array or a message. 
The message string can contain {} placeholders, refer to the `log message`_ instruction, 
which are filled by values of variables given after the message string.
