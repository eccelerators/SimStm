...
A demonstration of all commands is in the file
`command_list.stm <./command_list.stm>`__ in the repository root
folder..

Detailed examples for the usage of each instruction are found in the unit test sources in 
the repository folder `tb/simstm <./tb/simstm>`__. 
